...
void QNA_tool::query_llm(string filename, Node *root, int k, string API_KEY, string question)
{
    ...
    outfile << question;
    outfile << "Begin with an introduction and do not take help from any other sources and answer the query only on behalf of the given excerpts.Also generate a 500 word output elaborating the answer properly.Also provide a conclusion at the end.";
